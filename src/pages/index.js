    ...
    <div className="relative container flex justify-between flex-wrap px-8 pt-4 pb-24 md:py-16 md:px-12">
      <div className="z-10 flex flex-col text-center md:text-left w-full md:w-1/3">
        ...
        <div className="hidden md:flex mt-40">
          <a className="mr-8" href="https://github.com/eladiogaldamez" rel="noreferrer" target="_blank" title="github:EladioGaldamez"><span className="opacity-0">Github</span><FaGithub className="w-6 h-6 text-suit hover:text-white transition-all duration-200 ease-in-out" /></a>
          <a className="mr-8" href="https://www.linkedin.com/in/josegaldámez" rel="noreferrer" target="_blank" title="linkedin:EladioGaldamez"><span className="opacity-0">LinkedIn</span><FaLinkedinIn className="w-6 h-6 text-suit hover:text-white transition-all duration-200 ease-in-out" /></a>
        </div>
      </div>
      <div className="z-10 flex flex-col justify-start md:justify-end w-full md:w-1/3 mt-16 md:mt-64">
        ...
        <p className="text-suit text-base md:text-xl leading-none mt-4">
          Antig&uuml;e&ntilde;o, Desarrollador web y entusiata de la tecnolog&iacute;a. Desarrollando productos que ayudan a resolver problemas.
          Estudiante de <a href="https://platzi.com">Platzi</a>.
        </p>
      </div>
    ...
    <div className="py-16 md:py-32 bg-rock3">
      <div className="container flex justify-between flex-wrap px-8 md:px-12">
        ...
        <div className="flex flex-wrap items-center justify-between md:justify-end w-full md:w-2/3">
          <a href="https://apigee.com" target="_blank" rel="noreferrer" title="apigee"><span className="opacity-0">Apigee</span><Google className="text-commet w-24 md:w-40 mx-2 md:mx-8 my-4 hover:text-white transition-all duration-200 ease-in-out" /></a>
          <a href="https://barbless.co" target="_blank" rel="noreferrer" title="barbless"><span className="opacity-0">Barbless.co</span><Barbless className="text-commet w-24 md:w-40 mx-2 md:mx-8 my-4 hover:text-white transition-all duration-200 ease-in-out" /></a>
          ...
          <a href="https://teamninja.com" target="_blank" rel="noreferrer" title="team ninja"><span className="opacity-0">Team ninja</span><Ninja className="text-commet w-24 md:w-40 mx-2 md:mx-8 my-4 hover:text-white transition-all duration-200 ease-in-out" /></a>
          <a href="https://www.namecheap.com" target="_blank" rel="noreferrer" title="namecheap"><span className="opacity-0">Namecheap</span><Namecheap className="text-commet w-24 md:w-40 mx-2 md:mx-8 my-4 hover:text-white transition-all duration-200 ease-in-out" /></a>
          <a href="https://studio31.io" target="_blank" rel="noreferrer" title="studio 31"><span className="opacity-0">Studio31</span><Studio31 className="text-commet w-24 md:w-40 mx-2 md:mx-8 hover:text-white transition-all duration-200 ease-in-out" /></a>
          <a href="https://recorridoantigua.com" target="_blank" rel="noreferrer" title="recorrido antigua"><span className="opacity-0">Recorrido Antigua</span><RecorridoAntigua className="text-commet w-24 md:w-40 mx-2 md:mx-8 my-4 hover:text-white transition-all duration-200 ease-in-out" /></a>
        </div>
      </div>
    </div>
